...
public class AddContactsToChatViewModel extends AndroidViewModel {

    private MutableLiveData<List<Contact>> mContactList;

    public AddContactsToChatViewModel(@NonNull Application application) {
        super(application);
        mContactList = new MutableLiveData<>();
        mContactList.setValue(new ArrayList<>());
    }

    public void addUserContactListObserver(@NonNull LifecycleOwner owner,
    ...
    private void handleResult(final JSONObject response) {
        ...
        try {
            ...
            Log.e("JSON PARSE ERROR", "Found in handle Success AddContactsModel");
